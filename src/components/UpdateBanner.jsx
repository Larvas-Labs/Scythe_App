    ...
    <div
      style={{
        ...
        background: updateState === 'downloaded'
          ? 'oklch(63% 0.244 257 / 0.12)'
          : 'oklch(63% 0.244 257 / 0.07)',
        borderBottom: '1px solid oklch(63% 0.244 257 / 0.2)',
        flexShrink: 0,
      }}
    >
      ...
      {updateState === 'downloaded' && (
        <button
          ...
          style={{
            ...
            background: 'none',
            border: '1px solid oklch(63% 0.244 257 / 0.4)',
            borderRadius: '6px',
            padding: '3px 10px',
            cursor: 'pointer',
            transition: 'background 0.15s',
          }}
          onMouseEnter={e => e.currentTarget.style.background = 'oklch(63% 0.244 257 / 0.1)'}
