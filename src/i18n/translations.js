...
export const translations = {
  en: {
    ...
    'consent.tracked.open':       'When you open the app',
    'consent.tracked.scan':       'When you run a scan — duration and number of items found',
    'consent.tracked.delete':     'When files are deleted — number of items and bytes freed',
    'consent.tracked.update':     'When the app is updated',
    'consent.tracked.meta':       'App version and OS version',
    'consent.notTrackedHeader':   'What is never tracked',
    'consent.notTracked.paths':   'File paths or folder names',
    'consent.notTracked.identity':'Your name, username, or any personal information',
    'consent.notTracked.ip':      'Your IP address is not stored in our database',
    'consent.notTracked.id':      'Session ID is a random number — not tied to you',
  ...
  sv: {
    ...
    'consent.tracked.open':       'När du öppnar appen',
    'consent.tracked.scan':       'När du kör en scanning — varaktighet och antal hittade filer',
    'consent.tracked.delete':     'När filer raderas — antal och frigjorda bytes',
    'consent.tracked.update':     'När appen uppdateras',
    'consent.tracked.meta':       'App-version och OS-version',
    'consent.notTrackedHeader':   'Vad spåras aldrig',
    'consent.notTracked.paths':   'Filsökvägar eller mappnamn',
    'consent.notTracked.identity':'Ditt namn, användarnamn eller personlig information',
    'consent.notTracked.ip':      'Din IP-adress lagras inte i vår databas',
    'consent.notTracked.id':      'Session-ID är ett slumpmässigt nummer — inte kopplat till dig',
  ...
  de: {
    ...
    'consent.tracked.open':       'Wenn Sie die App öffnen',
    'consent.tracked.scan':       'Wenn Sie einen Scan ausführen — Dauer und Anzahl der gefundenen Elemente',
    'consent.tracked.delete':     'Wenn Dateien gelöscht werden — Anzahl und freigegebene Bytes',
    'consent.tracked.update':     'Wenn die App aktualisiert wird',
    'consent.tracked.meta':       'App-Version und OS-Version',
    'consent.notTrackedHeader':   'Was nie erfasst wird',
    'consent.notTracked.paths':   'Dateipfade oder Ordnernamen',
    'consent.notTracked.identity':'Ihr Name, Benutzername oder persönliche Informationen',
    'consent.notTracked.ip':      'Ihre IP-Adresse wird nicht in unserer Datenbank gespeichert',
    'consent.notTracked.id':      'Sitzungs-ID ist eine Zufallszahl — nicht mit Ihnen verknüpft',
  ...
  fr: {
    ...
    'consent.tracked.open':       'Quand vous ouvrez l\'app',
    'consent.tracked.scan':       'Quand vous lancez une analyse — durée et nombre d\'éléments trouvés',
    'consent.tracked.delete':     'Quand des fichiers sont supprimés — nombre et octets libérés',
    'consent.tracked.update':     'Quand l\'app est mise à jour',
    'consent.tracked.meta':       'Version de l\'app et version du système',
    'consent.notTrackedHeader':   'Ce qui n\'est jamais suivi',
    'consent.notTracked.paths':   'Chemins de fichiers ou noms de dossiers',
    'consent.notTracked.identity':'Votre nom, identifiant ou informations personnelles',
    'consent.notTracked.ip':      'Votre adresse IP n\'est pas stockée dans notre base de données',
    'consent.notTracked.id':      'L\'ID de session est un nombre aléatoire — non lié à vous',
  ...
  es: {
    ...
    'consent.tracked.open':       'Cuando abres la app',
    'consent.tracked.scan':       'Cuando ejecutas un análisis — duración y número de elementos encontrados',
    'consent.tracked.delete':     'Cuando se eliminan archivos — número y bytes liberados',
    'consent.tracked.update':     'Cuando la app se actualiza',
    'consent.tracked.meta':       'Versión de la app y versión del sistema',
    'consent.notTrackedHeader':   'Qué nunca se rastrea',
    'consent.notTracked.paths':   'Rutas de archivos o nombres de carpetas',
    'consent.notTracked.identity':'Tu nombre, nombre de usuario o información personal',
    'consent.notTracked.ip':      'Tu dirección IP no se almacena en nuestra base de datos',
    'consent.notTracked.id':      'El ID de sesión es un número aleatorio — no vinculado a ti',
